...
export interface ApiRewriteModelRewriteModel
  extends Struct.CollectionTypeSchema {
  collectionName: 'rewrite_models';
  info: {
    displayName: 'RewriteModel';
    pluralName: 'rewrite-models';
    singularName: 'rewrite-model';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiRewriteTemplateRewriteTemplate
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::rewrite-template.rewrite-template'
    >;
    model: Schema.Attribute.Relation<
      'oneToOne',
      'api::rewrite-model.rewrite-model'
    >;
